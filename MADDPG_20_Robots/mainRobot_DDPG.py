...
if __name__ == '__main__':
    ...
    Robot0 = Agent('actor0', 'critic0', 'actor0_target', 'critic0_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot1 = Agent('actor1', 'critic1', 'actor1_target', 'critic1_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot2 = Agent('actor2', 'critic2', 'actor2_target', 'critic2_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot3 = Agent('actor3', 'critic3', 'actor3_target', 'critic3_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot4 = Agent('actor4', 'critic4', 'actor4_target', 'critic4_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot5 = Agent('actor5', 'critic5', 'actor5_target', 'critic5_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot6 = Agent('actor6', 'critic6', 'actor6_target', 'critic6_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot7 = Agent('actor7', 'critic7', 'actor7_target', 'critic7_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot8 = Agent('actor8', 'critic8', 'actor8_target', 'critic8_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot9 = Agent('actor9', 'critic9', 'actor9_target', 'critic9_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot10 = Agent('actor10', 'critic10', 'actor10_target', 'critic10_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot11 = Agent('actor11', 'critic11', 'actor11_target', 'critic11_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot12 = Agent('actor12', 'critic12', 'actor12_target', 'critic12_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot13 = Agent('actor13', 'critic13', 'actor13_target', 'critic13_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot14 = Agent('actor14', 'critic14', 'actor14_target', 'critic14_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot15 = Agent('actor15', 'critic15', 'actor15_target', 'critic15_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot16 = Agent('actor16', 'critic16', 'actor16_target', 'critic16_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot17 = Agent('actor17', 'critic17', 'actor17_target', 'critic17_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot18 = Agent('actor18', 'critic18', 'actor18_target', 'critic18_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)
    Robot19 = Agent('actor19', 'critic19', 'actor19_target', 'critic19_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=8)    

    Robot0_mover = Agent('actor0_mover', 'critic0_mover', 'actor0_mover_target', 'critic0_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot1_mover = Agent('actor1_mover', 'critic1_mover', 'actor1_mover_target', 'critic1_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot2_mover = Agent('actor2_mover', 'critic2_mover', 'actor2_mover_target', 'critic2_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot3_mover = Agent('actor3_mover', 'critic3_mover', 'actor3_mover_target', 'critic3_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot4_mover = Agent('actor4_mover', 'critic4_mover', 'actor4_mover_target', 'critic4_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot5_mover = Agent('actor5_mover', 'critic5_mover', 'actor5_mover_target', 'critic5_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot6_mover = Agent('actor6_mover', 'critic6_mover', 'actor6_mover_target', 'critic6_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot7_mover = Agent('actor7_mover', 'critic7_mover', 'actor7_mover_target', 'critic7_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot8_mover = Agent('actor8_mover', 'critic8_mover', 'actor8_mover_target', 'critic8_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot9_mover = Agent('actor9_mover', 'critic9_mover', 'actor9_mover_target', 'critic9_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot10_mover = Agent('actor10_mover', 'critic10_mover', 'actor10_mover_target', 'critic10_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot11_mover = Agent('actor11_mover', 'critic11_mover', 'actor11_mover_target', 'critic11_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot12_mover = Agent('actor12_mover', 'critic12_mover', 'actor12_mover_target', 'critic12_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot13_mover = Agent('actor13_mover', 'critic13_mover', 'actor13_mover_target', 'critic13_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot14_mover = Agent('actor14_mover', 'critic14_mover', 'actor14_mover_target', 'critic14_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot15_mover = Agent('actor15_mover', 'critic15_mover', 'actor15_mover_target', 'critic15_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot16_mover = Agent('actor16_mover', 'critic16_mover', 'actor16_mover_target', 'critic16_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot17_mover = Agent('actor17_mover', 'critic17_mover', 'actor17_mover_target', 'critic17_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot18_mover = Agent('actor18_mover', 'critic18_mover', 'actor18_mover_target', 'critic18_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)
    Robot19_mover = Agent('actor19_mover', 'critic19_mover', 'actor19_mover_target', 'critic19_mover_target', alpha=LR_A, beta=LR_C, input_dims=[357], tau=0.001, n_actions=2)    
        ...
        for move in range(1000):
            ...
            for j in range(100):
                ...
                if np.random.random() <= epsilon:
                    ...
                    act10_robot = Robot10.choose_action(obs)
                    act11_robot = Robot11.choose_action(obs)
                    act12_robot = Robot12.choose_action(obs)
                    act13_robot = Robot13.choose_action(obs)
                    act14_robot = Robot14.choose_action(obs)
                    act15_robot = Robot15.choose_action(obs)
                    act16_robot = Robot16.choose_action(obs)
                    act17_robot = Robot17.choose_action(obs)
                    act18_robot = Robot18.choose_action(obs)
                    act19_robot = Robot19.choose_action(obs)                    
                ...
                Robot5.remember(obs, act5_robot, reward_Robot[5], new_state, done)
                Robot6.remember(obs, act6_robot, reward_Robot[6], new_state, done)
                Robot7.remember(obs, act7_robot, reward_Robot[7], new_state, done)
                Robot8.remember(obs, act8_robot, reward_Robot[8], new_state, done)
                Robot9.remember(obs, act9_robot, reward_Robot[9], new_state, done)
                Robot10.remember(obs, act10_robot, reward_Robot[10], new_state, done)
                Robot11.remember(obs, act11_robot, reward_Robot[11], new_state, done)
                Robot12.remember(obs, act12_robot, reward_Robot[12], new_state, done)
                Robot13.remember(obs, act13_robot, reward_Robot[13], new_state, done)
                Robot14.remember(obs, act14_robot, reward_Robot[14], new_state, done)
                Robot15.remember(obs, act15_robot, reward_Robot[15], new_state, done)
                Robot16.remember(obs, act16_robot, reward_Robot[16], new_state, done)
                Robot17.remember(obs, act17_robot, reward_Robot[17], new_state, done)
                Robot18.remember(obs, act18_robot, reward_Robot[18], new_state, done)
                Robot19.remember(obs, act19_robot, reward_Robot[19], new_state, done)                
