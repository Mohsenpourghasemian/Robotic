...
class RobotEnv(object):
    ...
    def step_task_offloading(self, action_APs, action_Robots, action_move):
        ...
        info = {}
        return observation_next, np.sum(reward_Robots), np.sum(reward_APs), done, info, accept, np.average(reward_VoI), np.average(reward_energy), self.Robots[0].posX, self.Robots[0].posY, self.Robots[1].posX, self.Robots[1].posY,
