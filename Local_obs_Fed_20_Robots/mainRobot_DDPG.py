    ...
    for i in range(1000):
        ...
        for move in range(1000):
            ...
            for k in range(1):
                ...
                # end of federation
            with open("02-reward_robot_LR_high_quantize_Energy_agressive_VoI_Reject.txt", 'a') as reward_robots:
                reward_robots.write(str(score_Robot) + '\n')
            with open("02-reward_AP_LR_high_quantize_Energy_agressive_VoI_Reject.txt", 'a') as reward_APs:
                reward_APs.write(str(score_AP) + '\n')
            with open("02-pos_0_high_Energy_quantize_agressive_VoI_Reject.txt", 'a') as pos0:
                pos0.write(str(posX0) + ', ' + str(posY0) + '\n')
            with open("02-pos_1_high_Energy_quantize_agressive_VoI_Reject.txt", 'a') as pos1:
