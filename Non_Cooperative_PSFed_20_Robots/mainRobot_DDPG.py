...
if __name__ == '__main__':
    ...
    Robot0 = Agent('actor0', 'critic0', 'actor0_target', 'critic0_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot1 = Agent('actor1', 'critic1', 'actor1_target', 'critic1_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot2 = Agent('actor2', 'critic2', 'actor2_target', 'critic2_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot3 = Agent('actor3', 'critic3', 'actor3_target', 'critic3_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot4 = Agent('actor4', 'critic4', 'actor4_target', 'critic4_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot5 = Agent('actor5', 'critic5', 'actor5_target', 'critic5_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot6 = Agent('actor6', 'critic6', 'actor6_target', 'critic6_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot7 = Agent('actor7', 'critic7', 'actor7_target', 'critic7_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot8 = Agent('actor8', 'critic8', 'actor8_target', 'critic8_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot9 = Agent('actor9', 'critic9', 'actor9_target', 'critic9_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot10 = Agent('actor10', 'critic10', 'actor10_target', 'critic10_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot11 = Agent('actor11', 'critic11', 'actor11_target', 'critic11_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot12 = Agent('actor12', 'critic12', 'actor12_target', 'critic12_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot13 = Agent('actor13', 'critic13', 'actor13_target', 'critic13_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot14 = Agent('actor14', 'critic14', 'actor14_target', 'critic14_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot15 = Agent('actor15', 'critic15', 'actor15_target', 'critic15_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot16 = Agent('actor16', 'critic16', 'actor16_target', 'critic16_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot17 = Agent('actor17', 'critic17', 'actor17_target', 'critic17_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot18 = Agent('actor18', 'critic18', 'actor18_target', 'critic18_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
    Robot19 = Agent('actor19', 'critic19', 'actor19_target', 'critic19_target', alpha=LR_A, beta=LR_C, input_dims=[148], tau=0.001, n_actions=4)
            ...
            for k in range(1):
                for j in range(100):
                    ...
                    if np.random.random() <= epsilon:
                        act0_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act1_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act2_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act3_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act4_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act5_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act6_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act7_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act8_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act9_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act10_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act11_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act12_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act13_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act14_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act15_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act16_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act17_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act18_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)
                        act19_robot = np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0), np.random.uniform(-1.0, 1.0)                        
                    ...
                    if i %10 == 0:
                        with open("02-accept_LR_high_Sensor_served.txt", 'a') as reward_APs:
                            reward_APs.write(str(accept) + '\n')
                        with open("02-AoI_LR_high_Sensor_served.txt", 'a') as AoI_file:
                            AoI_file.write(str(AoI) + '\n')
                        with open("02-energy_LR_high_Sensor_served.txt", 'a') as energy_file:
                            energy_file.write(str(energy) + '\n')
                    obs = new_state
                    obs_move = new_state
                # calculate federation
                # start federation
                if reward_Robot[0] >= np.average(reward_Robot):
                    Server_robot.actor_paramR0 = Robot0.get_param()
                    Server_robot.Robot0_sent = 1
                if reward_Robot[1] >= np.average(reward_Robot):
                    Server_robot.actor_paramR1 = Robot1.get_param()
                    Server_robot.Robot1_sent = 1
                if reward_Robot[2] >= np.average(reward_Robot):
                    Server_robot.actor_paramR2 = Robot2.get_param()
                    Server_robot.Robot2_sent = 1
                if reward_Robot[3] >= np.average(reward_Robot):
                    Server_robot.actor_paramR3 = Robot3.get_param()
                    Server_robot.Robot3_sent = 1
                if reward_Robot[4] >= np.average(reward_Robot):
                    Server_robot.actor_paramR4 = Robot4.get_param()
                    Server_robot.Robot4_sent = 1
                if reward_Robot[5] >= np.average(reward_Robot):
                    Server_robot.actor_paramR5 = Robot5.get_param()
                    Server_robot.Robot5_sent = 1
                if reward_Robot[6] >= np.average(reward_Robot):
                    Server_robot.actor_paramR6 = Robot6.get_param()
                    Server_robot.Robot6_sent = 1
                if reward_Robot[7] >= np.average(reward_Robot):
                    Server_robot.actor_paramR7 = Robot7.get_param()
                    Server_robot.Robot7_sent = 1
                if reward_Robot[8] >= np.average(reward_Robot):
                    Server_robot.actor_paramR8 = Robot8.get_param()
                    Server_robot.Robot8_sent = 1
                if reward_Robot[9] >= np.average(reward_Robot):
                    Server_robot.actor_paramR9 = Robot9.get_param()
                    Server_robot.Robot9_sent = 1
                if reward_Robot[10] >= np.average(reward_Robot):
                    Server_robot.actor_paramR10 = Robot10.get_param()
                    Server_robot.Robot10_sent = 1
                if reward_Robot[11] >= np.average(reward_Robot):    
                    Server_robot.actor_paramR11 = Robot11.get_param()
                    Server_robot.Robot11_sent = 1
                if reward_Robot[12] >= np.average(reward_Robot):
                    Server_robot.actor_paramR12 = Robot12.get_param()
                    Server_robot.Robot12_sent = 1
                if reward_Robot[13] >= np.average(reward_Robot):
                    Server_robot.actor_paramR13 = Robot13.get_param()
                    Server_robot.Robot13_sent = 1
                if reward_Robot[14] >= np.average(reward_Robot):
                    Server_robot.actor_paramR14 = Robot14.get_param()
                    Server_robot.Robot14_sent = 1
                if reward_Robot[15] >= np.average(reward_Robot):
                    Server_robot.actor_paramR15 = Robot15.get_param()
                    Server_robot.Robot15_sent = 1
                if reward_Robot[16] >= np.average(reward_Robot):
                    Server_robot.actor_paramR16 = Robot16.get_param()
                    Server_robot.Robot16_sent = 1
                if reward_Robot[17] >= np.average(reward_Robot):
                    Server_robot.actor_paramR17 = Robot17.get_param()
                    Server_robot.Robot17_sent = 1
                if reward_Robot[18] >= np.average(reward_Robot):
                    Server_robot.actor_paramR18 = Robot18.get_param()
                    Server_robot.Robot18_sent = 1
                if reward_Robot[19] >= np.average(reward_Robot):
                    Server_robot.actor_paramR19 = Robot19.get_param()
                    Server_robot.Robot19_sent = 1                
                ...
                Robot5.actor.params = actor_robot_new
                Robot6.actor.params = actor_robot_new
                Robot7.actor.params = actor_robot_new
                Robot8.actor.params = actor_robot_new
                Robot9.actor.params = actor_robot_new
                Robot10.actor.params = actor_robot_new
                Robot11.actor.params = actor_robot_new
                Robot12.actor.params = actor_robot_new
                Robot13.actor.params = actor_robot_new
                Robot14.actor.params = actor_robot_new
                Robot15.actor.params = actor_robot_new
                Robot16.actor.params = actor_robot_new
                Robot17.actor.params = actor_robot_new
                Robot18.actor.params = actor_robot_new
                Robot19.actor.params = actor_robot_new                
                AP1.actor.params = actor_AP_new
                AP2.actor.params = actor_AP_new
                AP3.actor.params = actor_AP_new
                AP4.actor.params = actor_AP_new
                Server_robot.Robot0_sent = 0
                Server_robot.Robot1_sent = 0
                Server_robot.Robot2_sent = 0
                Server_robot.Robot3_sent = 0
                Server_robot.Robot4_sent = 0
                Server_robot.Robot5_sent = 0
                Server_robot.Robot6_sent = 0
                Server_robot.Robot7_sent = 0
                Server_robot.Robot8_sent = 0
                Server_robot.Robot9_sent = 0
                Server_robot.Robot10_sent = 0
                Server_robot.Robot11_sent = 0
                Server_robot.Robot12_sent = 0
                Server_robot.Robot13_sent = 0
                Server_robot.Robot14_sent = 0
                Server_robot.Robot15_sent = 0
                Server_robot.Robot16_sent = 0
                Server_robot.Robot17_sent = 0
                Server_robot.Robot18_sent = 0
                Server_robot.Robot19_sent = 0                
                # end of federation
            with open("02-reward_robot_LR_high_Sensor_served_Reject.txt", 'a') as reward_robots:
                reward_robots.write(str(score_Robot) + '\n')
            with open("02-reward_AP_LR_high_Sensor_served_Reject.txt", 'a') as reward_APs:
                reward_APs.write(str(score_AP) + '\n')
            with open("02-pos_0_high_Energy_Sensor_served.txt", 'a') as pos0:
                pos0.write(str(posX0) + ', ' + str(posY0) + '\n')
            with open("02-pos_1_high_Energy_Sensor_served.txt", 'a') as pos1:
